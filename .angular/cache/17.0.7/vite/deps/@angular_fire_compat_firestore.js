...
import {
  ...
  ɵfirebaseAppFactory,
  ɵlazySDKProxy
} from "./chunk-KYWHXIDM.js";
import {
  firebase
} from "./chunk-X3ZUURFH.js";
import {
  ...
  where
} from "./chunk-6BNBPJWH.js";
import "./chunk-V4QTYWB6.js";
import {
  FirebaseApp
} from "./chunk-JKXD6FAG.js";
import {
  VERSION,
...
import {
  ...
  registerVersion,
  uuidv4
} from "./chunk-3VHIH3N4.js";
import {
  isPlatformServer
} from "./chunk-JECTGPSN.js";
import {
  Inject,
  Injectable,
  InjectionToken,
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name3, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-GR7BKFD7.js"))), map(() => ɵfirebaseAppFactory(options, zone, name3)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
